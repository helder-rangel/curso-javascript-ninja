...
carro.adicionarPessoas = function (numeroPessoas){
    ...
    console.log(quantasPessoasCabem);
    console.log(carro.quantidadePesosas);
    ...
    if(totalPessoas > carro.assentos){
        return 'Só cabem '+ quantasPessoasCabem +' ' + pluralOuSingular +' no carro'
    }
    //if(totalPessoas < carro.assentos)
...
carro.obterMarcaModelo(); // 'Esse carro é um voks esportivo'
...
peopleCar(-4);//"Já temos 1 pessoas no carro!"
